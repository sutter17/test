...
/**  A GUI for the game of Boggle.
  ...
  * Copyright (C) 2014 Raghuram Ramanujan <raramanujan@davidson.edu>
  *
...
public class BoggleGUI extends JFrame {
    ...
    public BoggleGUI(ILexicon lex, IWordOnBoardFinder finder,
        ...
        super( "Welcome to CSC 221 Boggle!");
    ...
    public void computerPlay() {
        ...
        computerPlayer.clear();
        java.util.List<String> wordsFound = 
            computerPlayer.findAllValidWords(myBoard, myLexicon);
        for (String s : wordsFound)
            computerPlayer.add(s);
    ...
    private class BoggleBoardPanel extends JPanel {
        ...
        public void highlightDice(java.util.List<BoardCell> locations) {
            ...
            for(BoardCell cell : locations) {
                highlightDie(cell.getRow(), cell.getCol());
            }
                ...
                public void actionPerformed( ActionEvent e) {
                    ...
                    if (myLexicon.wordStatus(s) != LexStatus.WORD){
                        ...
                        for(BoardCell cell : list){
                            myString.append(myBoard.getFace(cell.getRow(), cell.getCol()));
                        }
