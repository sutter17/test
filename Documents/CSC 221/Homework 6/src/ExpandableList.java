...
//public class ExpandableList extends JList<String> // Java 7
public class ExpandableList extends JList
{
    ...
    //private DefaultListModel<String> myModel;       // Java 7
	...
	//myModel = new DefaultListModel<String>(); // Java 7
    ...
    public synchronized void add(Object o)
			     //public synchronized void add(String s) // Java 7
    {
        myModel.addElement(o);   // old 1.1 vector interface
        //myModel.addElement(s); // Java 7
    }
